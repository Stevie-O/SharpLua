namespace SharpLua
{
    ...
    return index";
        ...
        internal SharpLua.Lua.lua_CFunction gcFunction, indexFunction, newindexFunction,
        ...
        public MetaFunctions(ObjectTranslator translator)
        {
            ...
            gcFunction = new SharpLua.Lua.lua_CFunction(this.collectObject);
            toStringFunction = new SharpLua.Lua.lua_CFunction(this.toString);
            indexFunction = new SharpLua.Lua.lua_CFunction(this.getMethod);
            newindexFunction = new SharpLua.Lua.lua_CFunction(this.setFieldOrProperty);
            baseIndexFunction = new SharpLua.Lua.lua_CFunction(this.getBaseMethod);
            callConstructorFunction = new SharpLua.Lua.lua_CFunction(this.callConstructor);
         ...
         */
        private int runFunctionDelegate(SharpLua.Lua.LuaState luaState)
        {
            SharpLua.Lua.lua_CFunction func = (SharpLua.Lua.lua_CFunction)translator.getRawNetObject(luaState, 1);
         ...
         */
        private int toString(SharpLua.Lua.LuaState luaState)
        {
        ...
        public static void dumpStack(ObjectTranslator translator, SharpLua.Lua.LuaState luaState)
        {
         ...
         */
        private int getMethod(SharpLua.Lua.LuaState luaState)
        {
            object obj = translator.getRawNetObject(luaState, 1);
            if (obj == null)
            {
         ...
         */
        private int getBaseMethod(SharpLua.Lua.LuaState luaState)
        {
            object obj = translator.getRawNetObject(luaState, 1);
            if (obj == null)
            {
         ...
         */
        private int getMember(SharpLua.Lua.LuaState luaState, IReflect objType, object obj, string methodName, BindingFlags bindingType)
        {
            bool implicitStatic = false;
            MemberInfo member = null;
            object cachedMember = checkMemberCache(memberCache, objType, methodName);
            //object cachedMember=null;
            if (cachedMember is SharpLua.Lua.lua_CFunction)
            {
                translator.pushFunction(luaState, (SharpLua.Lua.lua_CFunction)cachedMember);
            ...
            if (member != null)
            {
                ...
                else if (!implicitStatic)
                {
                    ...
                    else
                    {
                        ...
                        SharpLua.Lua.lua_CFunction wrapper = new SharpLua.Lua.lua_CFunction((new LuaMethodWrapper(translator, objType, methodName, bindingType)).call);
         ...
         */
        private int setFieldOrProperty(SharpLua.Lua.LuaState luaState)
        {
        ...
        private bool trySetMember(SharpLua.Lua.LuaState luaState, IReflect targetType, object target, BindingFlags bindingType, out string detailMessage)
        {
         ...
         */
        private int setMember(SharpLua.Lua.LuaState luaState, IReflect targetType, object target, BindingFlags bindingType)
        {
            string detail;
        ...
        void ThrowError(SharpLua.Lua.LuaState luaState, Exception e)
        {
         ...
         */
        private int getClassMethod(SharpLua.Lua.LuaState luaState)
        {
            IReflect klass;
            object obj = translator.getRawNetObject(luaState, 1);
#if WindowsCE
         ...
         */
        private int setClassFieldOrProperty(SharpLua.Lua.LuaState luaState)
        {
            IReflect target;
            object obj = translator.getRawNetObject(luaState, 1);
#if WindowsCE
         ...
         */
        private int callConstructor(SharpLua.Lua.LuaState luaState)
        {
        ...
        /// <returns></returns>
        private bool _IsTypeCorrect(SharpLua.Lua.LuaState luaState, int currentLuaParam, ParameterInfo currentNetParam, out ExtractValue extractValue)
        {
            try
            {
        ...
        private bool _IsParamsArray(SharpLua.Lua.LuaState luaState, int currentLuaParam, ParameterInfo currentNetParam, out ExtractValue extractValue)
        {
            extractValue = null;
