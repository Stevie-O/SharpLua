...
namespace SharpLua
{
	public partial class Lua
	{
		...
		public static T[] luaM_reallocv<T>(LuaState L, T[] block, int new_size)
		{
		...
		public static void luaM_freemem<T>(LuaState L, T b) { luaM_realloc_<T>(L, new T[] {b}, 0); }
		public static void luaM_free<T>(LuaState L, T b) { luaM_realloc_<T>(L, new T[] {b}, 0); }
		public static void luaM_freearray<T>(LuaState L, T[] b) { luaM_reallocv(L, b, 0); }

		public static T luaM_malloc<T>(LuaState L) { return (T)luaM_realloc_<T>(L); }
		public static T luaM_new<T>(LuaState L) { return (T)luaM_realloc_<T>(L); }
		public static T[] luaM_newvector<T>(LuaState L, int n)
		{
		...
		public static T[] luaM_reallocvector<T>(LuaState L, ref T[] v, int oldn, int n)
		{
		...
		*/
		...
		public static T[] luaM_growaux_<T>(LuaState L, ref T[] block, ref int size,
		...
		public static object luaM_toobig (LuaState L) {
		...
		*/
		...
		public static object luaM_realloc_(LuaState L, Type t)
		{
		...
		public static object luaM_realloc_<T>(LuaState L)
		{
		...
		public static object luaM_realloc_<T>(LuaState L, T obj)
		{
			int unmanaged_size = (int)GetUnmanagedSize(typeof(T));
		...
		public static object luaM_realloc_<T>(LuaState L, T[] old_block, int new_size)
		{
			int unmanaged_size = (int)GetUnmanagedSize(typeof(T));
