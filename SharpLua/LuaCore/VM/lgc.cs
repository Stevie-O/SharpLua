...
namespace SharpLua
{
	...
	public partial class Lua
	{
		...
		*/
		...
		public static byte luaC_white(GlobalState g) { return (byte)(g.currentwhite & WHITEBITS); }


		public static void luaC_checkGC(LuaState L)
		{
		...
		public static void luaC_barrier(LuaState L, object p, TValue v) { if (valiswhite(v) && isblack(obj2gco(p)))
			luaC_barrierf(L,obj2gco(p),gcvalue(v)); }

		public static void luaC_barriert(LuaState L, Table t, TValue v) { if (valiswhite(v) && isblack(obj2gco(t)))
		    luaC_barrierback(L,t); }

		public static void luaC_objbarrier(LuaState L, object p, object o)
			{ if (iswhite(obj2gco(o)) && isblack(obj2gco(p)))
				luaC_barrierf(L,obj2gco(p),obj2gco(o)); }

		public static void luaC_objbarriert(LuaState L, Table t, object o)
		...
		public static uint luaC_separateudata (LuaState L, int all) {
		  GlobalState g = G(L);
		  uint deadmem = 0;
		...
		*/
		...
		public static void sweepwholelist(LuaState L, GCObjectRef p) { sweeplist(L, p, MAX_LUMEM); }
		...
		*/
		public static void luaC_callGCTM (LuaState L) {
		  while (G(L).tmudata != null)
			GCTM(L);
		}


		public static void luaC_freeall (LuaState L) {
		  GlobalState g = G(L);
		  int i;
		...
		public static void luaC_step (LuaState L) {
		  GlobalState g = G(L);
		...
		public static void luaC_fullgc (LuaState L) {
		  GlobalState g = G(L);
		...
		public static void luaC_barrierf (LuaState L, GCObject o, GCObject v) {
		  GlobalState g = G(L);
		...
		public static void luaC_barrierback(LuaState L, Table t)
		{
		  GlobalState g = G(L);
		...
		public static void luaC_linkupval (LuaState L, UpVal uv) {
		  GlobalState g = G(L);
