    ...
    public partial class Lua
    {
        ...
        */
        ...
        public class LuaException : Exception
        {
            ...
            public LuaException(LuaState L, lua_longjmp c) { this.L = L; this.c = c; }
        }
		...
		*/
        ...
        public static Stream lua_popen(LuaState L, CharPtr c, CharPtr m) { luaL_error(L, LUA_QL("popen") + " not supported"); return null; }
        public static int lua_pclose(LuaState L, Stream file) { return 0; }
